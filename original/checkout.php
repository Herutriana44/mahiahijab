                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="textarea" class="form-control" maxlength="225" rows="3"
                                    placeholder="Masukkan (Prov, Kab, Kec, Ds, Nama Jalan, Rt/Rw, dst)"
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        Biaya Pengiriman <span class="text-danger" style="font-size: 11px;">*(POS Indonesia)</span>
                                    </div>
                                    <div class="col-sm-6 text-right">
                ...
                if (isset($_POST['pesan'])) {
                    ...
                    $query = "INSERT INTO tbl_order (id_pelanggan,nm_penerima,telp,provinsi,kota,kode_pos,alamat_pengiriman,catatan,tgl_order,ongkir,total_order)
                            VALUES ('$id_pelanggan','$nmPenerima','$no_telp','$provinsi','$kota','$kdPos','$alamat','$catatan','$tgl_order','$ongkir','$totalbayar')";
                    $result = mysqli_query($db,$query);
