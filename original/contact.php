...
<script>
    ...
    function initMap() {
        // Koordinat Tambun Selatan, Bekasi
        var tambunSelatan = {
            lat: -6.232708,
            lng: 107.021207
        };

        // Membuat peta baru dengan lokasi yang ditetapkan
        var map = new google.maps.Map(document.getElementById('googleMap'), {
            zoom: 15,
            center: tambunSelatan
        });

        // Menambahkan marker pada peta
        var marker = new google.maps.Marker({
            position: tambunSelatan,
            map: map
        });
    };
...
<!-- API Google Maps dengan callback untuk peta -->
<script async defer
