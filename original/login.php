...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/icon/mahialogo.png">
    ...
    <style>
        body {
            ...
            background: url(assets/img/bg-login-customer.jpg);
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="u" placeholder="Username" id="username" required="required">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                    <input type="password" class="form-control" id="password" name="p" placeholder="Password" required="required">
                </div>
            </div>
